...
ONBOARDING_PATH  = os.path.join(PROFILES_DIR, "onboarding.json")
SCHEDULER_PATH   = os.path.join(PROFILES_DIR, "scheduler.json")
AI_CONFIG_PATH   = os.path.join(PROFILES_DIR, "ai_assistant.json")
PERSISTENT_VARS_PATH = os.path.join(PROFILES_DIR, "persistent_vars.json")
